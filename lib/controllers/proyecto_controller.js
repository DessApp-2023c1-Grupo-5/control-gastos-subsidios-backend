...
export const getProyecto = async (req, res) => {
  ...
  res.json({
    titulo: 'Plataforma abierta de gestion de camaras IP y aplicaciones moviles para la seguridad civil ciudadana',
    tipo: 'Proyecto',
    organismo: 'UNAHUR',
    ...
    integrantes: ['Perez, Alejandro Julian', 'Rubiales, Aldo Jose','Dominguez, Leonardo Daniel','D\'amato, Juan Pablo'],
